<div class="container ">
    ...
    <form wire:submit.prevent="saveCar">
        <div class="row">
            <div class="form-group col-12 col-md-6 mb-4">
                ...
                <div class="input-group">
                    <input type="text" wire:model="car_name" class="form-control" placeholder="Enter Car Name" >
                </div>
            ...
            <div class="form-group col-12 col-md-6">
                ...
                <div class="input-group">
                    <input type="text" wire:model="car_brand" class="form-control" placeholder="Enter Car Brand" >
                </div>
            ...
            <div class="form-group col-12 col-md-6">
                ...
                <div class="input-group">
                    <input type="text" wire:model="engine_capacity" class="form-control" placeholder="Enter Engine Capacity" >
                </div>
        ...
        <button type="submit" class="btn btn-dark text-white">Add Car</button>
    </form>
</div>
